...
| `shopify-dw.accounts_and_administration.business_platform_contracts` | Regional mapping |
...
GROUP BY region_code, plus_started_month, path_category
ORDER BY region_code, plus_started_month, path_category
```
